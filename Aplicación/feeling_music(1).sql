...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-11-2024 a las 01:12:18
...
--
ALTER TABLE `modalidades`
  ADD CONSTRAINT `modalidades_ibfk_1` FOREIGN KEY (`alumno_id`) REFERENCES `alumno` (`id`),
  ADD CONSTRAINT `modalidades_ibfk_2` FOREIGN KEY (`profesor_id`) REFERENCES `profesor` (`id`);
